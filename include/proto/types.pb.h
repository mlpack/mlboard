...
template <> struct is_proto_enum< ::mlboard::DataType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::mlboard::DataType>() {
  return ::mlboard::DataType_descriptor();
}
